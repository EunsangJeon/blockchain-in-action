App = {
    ...
    initContract: function () {
        $.getJSON('BlindAuction.json', function (data) {
            App.contracts.BlindAuction = TruffleContract(data);
    ...
    handleWinner: function () {
        ...
        App.contracts.BlindAuction.deployed().then(function (instance) {
            ...
            const highestBid = web3.fromWei(res.logs[0].args.highestBid.toNumber());
            const text = "<br><br><b>Winner: </b>" + winner + "<br><br><b>Highest Bid: </b>" + highestBid + " ETH";
            $('#winner').html(text);
            web3.eth.getBalance(web3.eth.coinbase, (b, r) => {
    ...
    showNotification: function (phase) {
        const phaseId = App.biddingPhases[phase];
        const phaseText = App.auctionPhases[phaseId];
