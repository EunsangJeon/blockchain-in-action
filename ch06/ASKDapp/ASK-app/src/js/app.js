App = {
    ...
    handleRegister: function () {
        const deposit = $("#airlineRegDeposit").val();
        App.contracts.vote
            .deployed()
            .then(function (instance) {
    ...
    handleUnregister: function () {
        const airlineAddress = $("#airlineUnRegAddress").val();
        App.contracts.vote
            .deployed()
            .then(function (instance) {
    ...
    handleASKrequest: function () {
        const reqId = $("#askReqReqId").val();
        const flightId = $("#askReqFlightId").val();
        const psngrId = $("#askReqPsngrId").val();
        const nSeats = $("#askReqNumSeats").val();
        const toAirline = $("#askReqAddress").val();
        App.contracts.vote
            .deployed()
            .then(function (instance) {
    ...
    handleASKresponse: function () {
        const reqId = $("#askRespReqId").val();
        const success = $("#askRespFlightId").val().toLowerCase() === "true";
        const fromAirline = $("#askRespAddress").val();
    ...
    handleSettlePayment: function () {
        const reqId = $("#spReqId").val();
        const nSeats = $("#spNumSeats").val();
        const toAirline = $("#spAddress").val();
        // console.log("RequestId: " + reqId + " nSeats: " + nSeats + " toAirline: " + toAirline);
        const flightId = App.requests[reqId];
    ...
    handleReplenishEscrow: function () {
        const amount = $("#replenishAmount").val();
        App.contracts.vote
            .deployed()
            .then(function (instance) {
